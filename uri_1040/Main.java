...
public class Main {
    public static void main(String[] args) {
        ...
        String MENSAGEM_APROVACAO = "Aluno aprovado.";
        String MENSAGEM_REPROVACAO = "Aluno reprovado.";
        String MENSAGEM_MEDIA = "Media: %.1f\n";
        String MENSAGEM_MEDIA_FINAL = "Media final: %.1f\n";

        media = (notaUm * 2 + notaDois * 3 + notaTres * 4 + notaQuatro) / 10;

        if (media >= 7.0) {
            System.out.printf(MENSAGEM_MEDIA, media);
            System.out.println(MENSAGEM_APROVACAO);
        } else if (media < 5.0) {
            System.out.printf(MENSAGEM_MEDIA, media);
            System.out.println(MENSAGEM_REPROVACAO);
        } else {
            ...
            if(media > 5){
                System.out.println(MENSAGEM_APROVACAO);
                System.out.printf(MENSAGEM_MEDIA_FINAL, media);
            }else{
                System.out.println(MENSAGEM_REPROVACAO);
                System.out.printf(MENSAGEM_MEDIA_FINAL, media);
            }

...
int main() {
    int pecaA, qtdA, pecaB, qtdB;
    float price_pecaA, price_pecaB, total;
    scanf("%d %d %f", &pecaA, &qtdA, &price_pecaA);
    scanf("%d %d %f", &pecaB, &qtdB, &price_pecaB);

    total = (qtdA * price_pecaA) + (qtdB * price_pecaB);
